...
document.getElementById("run").addEventListener("click", event => {
    debugger;
    function findJeanDupont(personen){
       return (personen.firstname === "Jean" && personen.lastname === "Dupont");


    }

    console.log(people.find(findJeanDupont).email);
    console.log(people.findIndex(findJeanDupont));
